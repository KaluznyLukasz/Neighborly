...
Systematically scan Apple's developer documentation via the Sosumi MCP, identify deprecated SwiftUI APIs and their modern replacements, and update `nei-swiftui-expert-skill/references/latest-apis.md`.
...
Read `nei-swiftui-expert-skill/references/latest-apis.md` to understand:
...
2. Commit changes to `nei-swiftui-expert-skill/references/latest-apis.md`.
